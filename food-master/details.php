...
$hasil = mysqli_query($con,"SELECT * FROM wallet_details where id = $user_id");
...
<div>
              ...
              <div class="errorTxt6"></div>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-action-home prefix"></i>
                          <textarea name="number" id="number" class="materialize-textarea validate" data-error=".errorTxt6"><?php echo $number;?></textarea>
              ...
              <div class="errorTxt7"></div>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-action-home prefix"></i>
                          <textarea name="cvv" id="cvv" class="materialize-textarea validate" data-error=".errorTxt6"><?php echo $cvv;?></textarea>
