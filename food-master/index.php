        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
            <div class="row">
              ...
              <div class = "row">
              <div class="col s12 m4 l3">
                <h4 class="header">Order table</h4>
              </div>
              <div>
                  <table id="data-table-customer" class="responsive-table display" cellspacing="0">
                    <thead>
                    ...
                    <tbody>
				<?php
                $result = mysqli_query($con, "SELECT * FROM pilihanTempat ;");
                $keperluan = mysqli_query($con,"SELECT * FROM meja");
				while($row = mysqli_fetch_array($result))
				{
                    ...
                    // </select></td>';
                    if($kep = mysqli_fetch_array($keperluan,MYSQL_ASSOC)){
                        echo '<tr><td>'.$row["Nama"].'</td>';
                        echo  '     <td><select name="people " id="people " class="row ">';
                        echo  '         <option value="#"></option>';
                        echo  '         <option value="'.$kep.'">2 orang</option>';   
                        echo  '         <option value="'.$kep.'">5 orang</option>';
                        echo  '         <option value="'.$kep.'">party </option>';                                          
                        echo  '     </select></td>';
                    }					
				}
				?>
