...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="images/icon/dashboard.jpg" alt="Cool Admin" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="#">
                                <i class="fas fa-chart-bar"></i>Makanan</a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fas fa-table"></i>Meja</a>
                        </li>
                        <li class="active">
                            <a href="form.html">
                                <i class="far fa-check-square"></i>tambah admin</a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fas fa-calendar-alt"></i>Minuman</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Pages</a>
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="rambahsql.php" method="post" class="form-horizontal">
