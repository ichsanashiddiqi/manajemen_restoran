...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form method="post" action="routers/routerKoki.php" class="login-form" id="form">
        <div class="row">
          <div class="input-field col s12 center">
           <p class="center login-form-text " ><h5>~KOKI~</h5></p>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <p class="margin medium-small"><a href="..\index.php">Back</a></p>
          </div>
        </div>        
        </div>
